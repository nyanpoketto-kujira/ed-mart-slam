...
public:
	...
	static void Start() {
		SetUp();
		SDK::CameraControl.Move(0.0, 0.0);
		SDK::CameraControl.SetZoom(1.0);
		SDK::Scene.AddObject(new GameOverScreen, "game_over_screen", LAYER1, true);
	}
...
#pragma region FoldRegion 
	...
	inline static GameOverMode* M_Inst;

	GameOverMode() { M_Inst = this; }
